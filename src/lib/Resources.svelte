...
import { dynasty } from './utils/helper';
    ...
    const resources = [
        ...
        {
            name: "Reddit - Fantasy Football Advice",
            url: "https://www.reddit.com/r/fantasyfootballadvice/",
            icon: "article",
            premium: false,
            separator: true,
            redraftOnly: true,
        ...
        {
            name: "Sleeper Dynasty Rankings Comparison",
            url: "https://www.dynastysuperflex.com/",
            icon: "insights",
            premium: false,
            separator: true,
            dynastyOnly: true,
